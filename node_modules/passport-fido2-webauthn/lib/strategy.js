...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var self = this;
  console.log('@@@@@@ @@@@@ @@@@@ @@@@@ webauthn: authenticate', req.body, clientData, response);
  console.error('@@@@@@ @@@@@ @@@@@ @@@@@ webauthn: authenticate', req.body, clientData, response);
  function validated(err, ok, ctx) {
    console.log('====== ====== ====== ====== webauthn: validated', err, ok, ctx);
    console.error('====== ====== ====== ====== webauthn: validated', err, ok, ctx);
    ...
    if (origin !== clientData.origin) {
      console.log('Origin mismatch: %s != %s', origin, clientData.origin);
